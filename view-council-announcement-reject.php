...
<main class=" py-5 mt-5">
  ...
  <div class="row">
      <div class="col-md-12">
        ...
        <h2><b>Departmental Councils</b></h2>
    ...
    <div class="row mt-5">
      <div class="col-md-12">
        ...
        <table class="table" id="dtBasicExample">
          ...
          <tbody>
            <?php 
            $qrycscann = mysqli_query($connection, "select * from council_club_announcement_view where isApproved = 'Reject'");
 ...
 -->                
      ...
      <!-- Modal -->
        <div class="modal fade" id="exampleModalCenter<?php echo $rescscann['CounID']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         ...
         <!-- Modal -->
        <div class="modal fade" id="rejectmodal<?php echo $rescscann['CounID']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
          aria-hidden="true">

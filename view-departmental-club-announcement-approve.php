        ...
        <table class="table" id="dtBasicExample">
          ...
          <tbody>
            ...
            while ($rescscann = mysqli_fetch_assoc($qrycscann)) { ?>
              ...
              <td><a href="" class="btn btn-default blue-gradient itogglebutton mb-4" data-toggle="modal" data-target="#modalContactForm<?php echo $rescscann['DannouncementID']; ?>">View</a></td>

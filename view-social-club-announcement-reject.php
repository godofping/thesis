    ...
    <div class="row mt-5">
      <div class="col-md-12">
        ...
        <table class="table" id="dtBasicExample">
          ...
          <tbody>
            <?php 
            $qrycscann = mysqli_query($connection, "select * from social_club_announcement_view where isApproved = 'Reject'");
        ...
        <div class="modal fade" id="exampleModalCenter<?php echo $rescscann['socialClubId']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         ...
         <!-- Modal -->
        <div class="modal fade" id="rejectmodal<?php echo $rescscann['socialClubId']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
          aria-hidden="true">

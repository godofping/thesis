          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer d-flex justify-content-center">
                ...
                <?php endif ?>
                <!-- <button type="button" class="btn btn-unique" data-toggle="modal" data-target="#exampleModalCenter<?php echo $rescscann['csc_announcementID']; ?>">Approve <i class="fas fa-paper-plane-o ml-1"></i></button> -->
                <button type="button" class="btn btn-unique" data-toggle="modal" data-target="#rejectmodal<?php echo $rescscann['csc_announcementID']; ?>">Reject <i class="fas fa-paper-plane-o ml-1"></i></button>
              </div>
            </form> 
          </div>
          </div>

            ...
            <div class="modal-dialog cascading-modal modal-avatar modal-sm" role="document">
              <div class="modal-content ">
                ...
                <div class="md-form ml-0 mr-0"> 
                  ...
                  <div class="">
                    <button class="btn blue-gradient mt-1 itogglebutton"><i class="fas fa-check"></i></button>
                    <button class="btn btn-danger mt-1 itogglebutton" data-dismiss="modal"><i class="fas fa-times"></i></button>
                  </div>

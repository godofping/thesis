  ...
  <div class="row">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <button class="btn blue-gradient" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus"></i> ADD CBTV officer</button>

        <?php 

                    $qrys = mysqli_query($connection, "select * from council_table where CounID = '2' ");
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <input type="text" name="from" value="add-cbtv-member" hidden>
      ...
      <div class="col-md-12 z-depth-2">
        ...
        <table class="table">
          ...
          <tbody>       
            ...
            <?php 
            $qry = mysqli_query($connection, "select * from council_view where CounID = '2'");
            while ($res = mysqli_fetch_assoc($qry)) { ?>
               <tr>
            ...
            <div class="modal fade" id="editModal<?php echo $res['councilID'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                ...
                <div class="row">
                    ...
                    <input type="text" name="from" value="edit-cbtv-position" hidden>
                  </div>
                  <div class="modal-footer">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <input type="text" name="councilID" value="<?php echo $res['councilID'] ?>" hidden>
                    <input type="text" name="from" value="delete-cbtv-position" hidden>

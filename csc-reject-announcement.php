...
<main class=" py-5 mt-5">
  ...
  <div class="row">
      <div class="col-md-12">
        ...
        <h2>central student council Rejected Announcement</h2>
        <hr>
        ...
        <table class="table" id="dtBasicExample">
          ...
          <tbody>
            ...
            while ($rescscann = mysqli_fetch_assoc($qrycscann)) { ?>
              ...
              <td><a href="" class="btn btn-info itogglebutton" data-toggle="modal" data-target="#modalContactForm<?php echo $rescscann['csc_announcementID']; ?>">View</a></td>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body mx-3">
                ...
                <?php 
                        ...
                        $qrydpannname = mysqli_query($connection, " select * from csc_announcement_table where csc_announcementID = '".$rescscann['csc_announcementID']."' ");
                        $resultann = mysqli_fetch_assoc($qrydpannname);

                        $qryvenue = mysqli_query($connection, " select * from csc_announcement_view where csc_announcementID = '".$rescscann['csc_announcementID']."' ");
              ...
              <input type="text" name="from" value="resend-csc-announcement" hidden>

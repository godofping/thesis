...
<main class=" py-5 mt-5">
  ...
  <div class="row">
      ...
      <div class="col-md-12">
                  ...
                  <a href="" class="btn aqua-gradient addofficer mb-4" data-toggle="modal" data-target="#modalContactForm<?php echo $resstID1['CounID'] ?>"><i class="fas fa-plus"></i><br><br> Create <br>Announcement</a>
                  <a href="council-status-announcement.php" class="btn peach-gradient addofficer mb-4"><i class="fas fa-spinner"></i><br><br>  Pending<br>Announcement</a>

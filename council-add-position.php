...
<main class=" py-5 mt-5">
  ...
  <div class="row">
      <div class="col-md-12">
        ...
        <h2>Departmental Council Club</h2>
        <h5>Position</h5>
        <hr>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <button class="btn blue-gradient" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus"></i> ADD Council Position</button>
          ...
          <tbody>
           <?php 
            ...
            while ($res = mysqli_fetch_assoc($qry)) { ?>
              ...
              <td><button class="btn aqua-gradient" data-toggle="modal" data-target="#editModal<?php echo $res['positionIDcouncil'] ?>"><i class="far fa-edit"></i></button> <button class="btn btn-danger" data-toggle="modal" data-target="#deleteModal<?php echo $res['positionIDcouncil'] ?>"><i class="far fa-trash-alt"></i></button></td>

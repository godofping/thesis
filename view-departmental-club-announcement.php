          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body mx-3">
                ...
                <ul id="tae<?php echo $rescscann['DannouncementID']; ?>">
              ...
              <div class="modal-footer d-flex justify-content-center">
                ...
                <button id="igit<?php echo $rescscann['DannouncementID']; ?>" type="button" class="btn aqua-gradient itogglebutton" data-toggle="modal" data-target="#exampleModalCenter<?php echo $rescscann['DannouncementID']; ?>">Approve <i class="fas fa-paper-plane-o ml-1"></i></button>  
                <?php endif ?>
                ...
                <?php endif ?>
                <button type="button" class="btn btn-danger itogglebutton" data-toggle="modal" data-target="#rejectmodal<?php echo $rescscann['DannouncementID']; ?>">Reject <i class="fas fa-paper-plane-o ml-1"></i></button>
              </div>
            </form> 
          </div>
          </div>
...
<script type="text/javascript">
  if ($('ul#tae<?php echo $rescscann['DannouncementID']; ?> li').length)
   {
    $('#igit<?php echo $rescscann['DannouncementID']; ?>').prop('disabled', true);
  }
</script>

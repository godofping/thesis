...
<div class="col-md-4">
    ...
    <div class="mt-5">
          ...
          <p class="h4 mb-4 text-center pt-4">My Departmental Clubs</p>
         ...
         <p class="h4 mb-4 text-center pt-4">My Council Clubs</p>
  ...
  <div class="col-md-4">
    ...
    <div class="mt-5">
          ...
          <p class="h4 mb-4 text-center pt-4">My Social Clubs</p>

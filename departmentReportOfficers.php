  ...
  <div class="row">
      <div class="col-md-12">
        ...
        <div class="md-form mt-1" style="text-align: center;">
              <p style="color: black"><b><U>List of <?php echo $title; ?> of <?php echo $departmentClubName; ?> Clubs</U></p></b>
            </div>
        <hr>
      </div>
    </div>
    ...
    <div class="row mt-5">
      <div class="col-md-12">
        ...
        <table class="table" id="dtBasicExample">
          ...
          <tbody>
            <?php 
            $qry = mysqli_query($connection, "select * from departmental_report_view where departmentClubId = '".$departmentClubId."' ");

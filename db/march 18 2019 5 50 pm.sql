...
insert  into `dsa_announcement_isread_table`(`dsaAnnouncementIsReadID`,`stprofID`,`dsaAnnouncementID`) values (58,11,1),(59,11,2),(60,11,3);
...
insert  into `dsa_announcement_table`(`dsaAnnouncementID`,`dateAnnounced`,`toWhom`,`message`) values (1,'2019-03-19','aww','hey'),(2,'2019-03-18','asdad','asdadaaaa'),(3,'2019-03-19','to all collge student','hi there');

...
insert  into `admin_account_table`(`adminID`,`username`,`password`) values (3,'admin','admin'),(4,'admins','ss');
...
insert  into `buttontoggle_table`(`showID`,`toggleonoroff`) values (1,'HIDE');
...
insert  into `council_announcement_table`(`council_announcementID`,`dateSubmit`,`toWhom`,`message`,`CounID`,`isApproved`,`timeStart`,`timeEnd`,`subjectann`,`venueID`,`annreason`) values (25,'2019-09-08 11:39:28','sadasd','ads',1,'Reject','2019-09-10 10:00:00','2019-09-10 11:00:00','asdad',9,'the date is expired'),(26,'2019-09-12 06:03:09','sd','awds',1,'No','2019-09-12 14:30:00','2019-09-12 15:30:00','dsd',9,NULL);
...
CREATE TABLE `council_officers_table` (
  ...
  KEY `FK_council_officers_tablex` (`positionID`),
  ...
  CONSTRAINT `FK_council_officers_tablex` FOREIGN KEY (`positionID`) REFERENCES `club_position_table` (`positionID`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=latin1;

/*Data for the table `council_officers_table` */

insert  into `council_officers_table`(`councilID`,`CounID`,`stprofID`,`positionID`,`perpost`) values (35,1,12,15,'Yes'),(41,2,18,15,'Yes'),(42,3,14,15,'Yes');
...
insert  into `councilreject_announcement_table`(`council_rejectID`,`stprofID`,`council_announcementID`,`CounID`,`isApproved`) values (12,12,25,1,'Reject');
...
insert  into `course_table`(`CourseID`,`CourseName`,`departmentClubId`,`CounID`) values (1,'Bachelor of Science in Computer Science',1,1),(4,'Bachelor of Science  in Nursing',3,3),(6,'Bachelor of Science in Hospitality Management',4,2),(7,'Bachelor of Science in Computer Engineering',2,1);
...
CREATE TABLE `csc_members_table` (
  ...
  KEY `FK_csc_members_tables` (`positionID`),
  CONSTRAINT `FK_csc_members_table` FOREIGN KEY (`stprofID`) REFERENCES `studentprofile_table` (`stprofID`),
  CONSTRAINT `FK_csc_members_tables` FOREIGN KEY (`positionID`) REFERENCES `club_position_table` (`positionID`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=latin1;

/*Data for the table `csc_members_table` */

insert  into `csc_members_table`(`cscmemID`,`stprofID`,`positionID`,`perpost`) values (15,16,15,'Yes'),(16,17,16,'No'),(17,18,17,'No');
...
CREATE TABLE `departmental_officersandmembers_table` (
  ...
  KEY `FK_departmental_officersandmembers_tables` (`positionID`),
  ...
  CONSTRAINT `FK_departmental_officersandmembers_tables` FOREIGN KEY (`positionID`) REFERENCES `club_position_table` (`positionID`),
...
insert  into `departmental_officersandmembers_table`(`departmentmemID`,`departmentClubId`,`positionID`,`stprofID`,`perpost`) values (1,1,15,12,'Yes');
...
insert  into `dsa_announcement_isread_table`(`dsaAnnouncementIsReadID`,`stprofID`,`dsaAnnouncementID`) values (27,12,6),(28,16,6),(29,19,6),(30,18,6);
...
insert  into `dsa_announcement_table`(`dsaAnnouncementID`,`dateSubmit`,`toWhom`,`message`,`timeStart`,`timeEnd`,`subjectann`,`isApproved`,`venueID`) values (6,'2019-09-08 11:36:27','aw','aw','2019-09-10 09:00:00','2019-09-09 10:00:00','aw','Yes',8);
...
CREATE TABLE `social_officerandmembers_table` (
  ...
  KEY `FK_social_officerandmembers_tables` (`positionID`),
  ...
  CONSTRAINT `FK_social_officerandmembers_tables` FOREIGN KEY (`positionID`) REFERENCES `club_position_table` (`positionID`),
...
insert  into `social_officerandmembers_table`(`socialoffID`,`socialClubId`,`positionID`,`stprofID`,`perpost`) values (11,10,15,16,'Yes');
...
insert  into `student_account_table`(`accID`,`StudentID`,`StudentPassword`,`isDeleted`) values (16,1,'1',0),(17,2,'2',0),(18,3,'12',0),(19,12,'1',0),(23,4,'123',0),(24,7,'7',0),(25,8,'8',0),(26,35181,'aw',0);
...
insert  into `student_portfolio_table`(`stportfolioID`,`stprofID`,`styear`,`sem`,`schoolyr`,`act1`,`rank1`,`act2`,`rank2`,`act3`,`rank3`,`act4`,`rank4`,`comm1`,`comm2`,`comm3`,`comm4`,`seminar1`,`seminar2`,`seminar3`,`seminar4`) values (1,12,'4th Year','1st Semester','2019-2020','S.o days Mass dance','1st place','dasda','2nd place','','','','','community service','','','','tablet',NULL,NULL,NULL);
...
insert  into `student_social_table`(`stdsocialID`,`stprofID`,`socialClubId`) values (12,12,8),(14,14,8),(15,15,10),(16,16,5),(18,17,8),(19,18,6),(20,19,8);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `council_view` AS select `council_officers_table`.`councilID` AS `councilID`,`council_officers_table`.`CounID` AS `CounID`,`council_table`.`CounName` AS `CounName`,`council_officers_table`.`stprofID` AS `stprofID`,`studentprofile_table`.`fname` AS `fname`,`studentprofile_table`.`mname` AS `mname`,`studentprofile_table`.`lname` AS `lname`,`council_officers_table`.`positionID` AS `positionID`,`club_position_table`.`positionName` AS `positionName`,`council_officers_table`.`perpost` AS `perpost` from (((`council_officers_table` join `club_position_table` on((`council_officers_table`.`positionID` = `club_position_table`.`positionID`))) join `council_table` on((`council_officers_table`.`CounID` = `council_table`.`CounID`))) join `studentprofile_table` on((`council_officers_table`.`stprofID` = `studentprofile_table`.`stprofID`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `csc_mem_view` AS select `csc_members_table`.`cscmemID` AS `cscmemID`,`csc_members_table`.`stprofID` AS `stprofID`,`studentprofile_table`.`fname` AS `fname`,`studentprofile_table`.`mname` AS `mname`,`studentprofile_table`.`lname` AS `lname`,`csc_members_table`.`positionID` AS `positionID`,`club_position_table`.`positionName` AS `positionName`,`csc_members_table`.`perpost` AS `perpost` from ((`csc_members_table` join `club_position_table` on((`csc_members_table`.`positionID` = `club_position_table`.`positionID`))) join `studentprofile_table` on((`csc_members_table`.`stprofID` = `studentprofile_table`.`stprofID`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `departmental_officersandmembers_view` AS select `departmental_officersandmembers_table`.`departmentmemID` AS `departmentmemID`,`departmental_officersandmembers_table`.`departmentClubId` AS `departmentClubId`,`departmental_club_table`.`departmentClubName` AS `departmentClubName`,`departmental_officersandmembers_table`.`positionID` AS `positionID`,`club_position_table`.`positionName` AS `positionName`,`departmental_officersandmembers_table`.`stprofID` AS `stprofID`,`studentprofile_table`.`fname` AS `fname`,`studentprofile_table`.`mname` AS `mname`,`studentprofile_table`.`lname` AS `lname`,`departmental_officersandmembers_table`.`perpost` AS `perpost` from (((`departmental_officersandmembers_table` join `departmental_club_table` on((`departmental_officersandmembers_table`.`departmentClubId` = `departmental_club_table`.`departmentClubId`))) join `club_position_table` on((`departmental_officersandmembers_table`.`positionID` = `club_position_table`.`positionID`))) join `studentprofile_table` on((`departmental_officersandmembers_table`.`stprofID` = `studentprofile_table`.`stprofID`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `social_officerandmembers_view` AS select `social_officerandmembers_table`.`socialoffID` AS `socialoffID`,`social_officerandmembers_table`.`socialClubId` AS `socialClubId`,`social_club_table`.`socialClubName` AS `socialClubName`,`social_officerandmembers_table`.`positionID` AS `positionID`,`club_position_table`.`positionName` AS `positionName`,`social_officerandmembers_table`.`stprofID` AS `stprofID`,`studentprofile_table`.`fname` AS `fname`,`studentprofile_table`.`mname` AS `mname`,`studentprofile_table`.`lname` AS `lname`,`social_officerandmembers_table`.`perpost` AS `perpost` from (((`social_officerandmembers_table` join `social_club_table` on((`social_officerandmembers_table`.`socialClubId` = `social_club_table`.`socialClubId`))) join `club_position_table` on((`social_officerandmembers_table`.`positionID` = `club_position_table`.`positionID`))) join `studentprofile_table` on((`social_officerandmembers_table`.`stprofID` = `studentprofile_table`.`stprofID`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `student_portfolio_view` AS select `student_portfolio_table`.`stportfolioID` AS `stportfolioID`,`student_portfolio_table`.`stprofID` AS `stprofID`,`studentprofile_table`.`fname` AS `fname`,`studentprofile_table`.`mname` AS `mname`,`studentprofile_table`.`lname` AS `lname`,`studentprofile_table`.`CourseID` AS `CourseID`,`course_table`.`CourseName` AS `CourseName`,`course_table`.`departmentClubId` AS `departmentClubId`,`departmental_club_table`.`departmentClubName` AS `departmentClubName`,`student_portfolio_table`.`styear` AS `styear`,`student_portfolio_table`.`sem` AS `sem`,`student_portfolio_table`.`schoolyr` AS `schoolyr`,`student_portfolio_table`.`act1` AS `act1`,`student_portfolio_table`.`rank1` AS `rank1`,`student_portfolio_table`.`act2` AS `act2`,`student_portfolio_table`.`rank2` AS `rank2`,`student_portfolio_table`.`act3` AS `act3`,`student_portfolio_table`.`rank3` AS `rank3`,`student_portfolio_table`.`act4` AS `act4`,`student_portfolio_table`.`rank4` AS `rank4`,`student_portfolio_table`.`comm1` AS `comm1`,`student_portfolio_table`.`comm2` AS `comm2`,`student_portfolio_table`.`comm3` AS `comm3`,`student_portfolio_table`.`comm4` AS `comm4`,`student_portfolio_table`.`seminar1` AS `seminar1`,`student_portfolio_table`.`seminar2` AS `seminar2`,`student_portfolio_table`.`seminar3` AS `seminar3`,`student_portfolio_table`.`seminar4` AS `seminar4` from (((`student_portfolio_table` join `studentprofile_table` on((`student_portfolio_table`.`stprofID` = `studentprofile_table`.`stprofID`))) join `course_table` on((`studentprofile_table`.`CourseID` = `course_table`.`CourseID`))) join `departmental_club_table` on((`course_table`.`departmentClubId` = `departmental_club_table`.`departmentClubId`))) */;

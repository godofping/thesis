...
insert  into `admincouncil_announcement_isread_table`(`admincouncilReadID`,`adminID`,`council_announcementID`) values (6,3,25),(7,4,25);
...
insert  into `admincsc_announcement_isread_table`(`admincsc_announcementID`,`adminID`,`csc_announcementID`) values (1,3,1),(2,3,4),(3,3,5),(4,3,6);
...
insert  into `admindepartment_announcement_isread_table`(`admindepartmentReadId`,`adminID`,`DannouncementID`) values (1,3,1);
...
insert  into `adminsocial_announcement_isread_table`(`adminsocial_announcementID`,`adminID`,`social_announcementID`) values (1,3,1);
...
insert  into `buttontoggle_table`(`showID`,`toggleonoroff`) values (1,'OFF');
...
insert  into `council_announcement_isread_table`(`council_announcementReadID`,`stprofID`,`council_announcementID`,`CounID`,`isApproved`) values (1,19,27,2,'Yes'),(2,12,28,1,'Yes'),(3,25,28,1,'Yes');
...
insert  into `council_announcement_table`(`council_announcementID`,`dateSubmit`,`toWhom`,`message`,`CounID`,`isApproved`,`timeStart`,`timeEnd`,`subjectann`,`venueID`,`annreason`) values (25,'2019-09-08 11:39:28','sadasd','ads',1,'Reject','2019-09-10 10:00:00','2019-09-10 11:00:00','asdad',9,'the date is expired'),(26,'2019-09-12 06:03:09','sd','awds',1,'Reject','2019-09-12 14:30:00','2019-09-12 15:30:00','dsd',9,''),(27,'2020-01-29 01:54:45','sadd','asdda',2,'Yes','2020-01-29 22:30:00','2020-01-29 23:30:00','adsad',8,NULL),(28,'2020-02-10 09:25:33','asdad','asdadad',1,'Yes','2020-02-14 10:30:00','2020-02-14 11:30:00','adasda',8,NULL);
...
insert  into `council_officers_table`(`councilID`,`CounID`,`stprofID`,`positionIDcouncil`,`perpost`) values (55,2,18,3,'No'),(61,3,23,3,'No'),(65,1,17,6,'No'),(66,1,25,1,'Yes'),(67,2,19,6,'Yes'),(68,1,12,2,'Yes');
...
insert  into `councilreject_announcement_table`(`council_rejectID`,`stprofID`,`council_announcementID`,`CounID`,`isApproved`) values (12,12,25,1,'Reject'),(13,17,25,1,'Reject'),(14,12,26,1,'Reject'),(15,25,25,1,'Reject'),(16,25,26,1,'Reject');
...
insert  into `csc_announcement_isread_table`(`csc_announcementReadID`,`stprofID`,`csc_announcementID`,`isApproved`) values (1,12,1,'Yes'),(2,16,1,'Yes'),(3,12,2,'Yes'),(4,16,2,'Yes'),(5,17,1,'Yes'),(6,14,1,'Yes'),(7,20,1,'Yes'),(8,20,2,'Yes'),(9,21,1,'Yes'),(10,21,2,'Yes'),(11,22,1,'Yes'),(12,23,1,'Yes'),(13,23,2,'Yes'),(14,25,1,'Yes'),(15,25,2,'Yes'),(16,15,1,'Yes'),(17,15,2,'Yes'),(18,19,1,'Yes'),(19,19,2,'Yes');
...
insert  into `csc_announcement_table`(`csc_announcementID`,`dateSubmit`,`toWhom`,`message`,`isApproved`,`timeStart`,`timeEnd`,`subjectann`,`venueID`,`annreason`) values (1,'2019-09-24 03:09:25','adsda','adsad','Yes','2019-09-25 10:00:00','2019-09-25 11:00:00','adada',8,NULL),(2,'2019-10-04 04:10:14','sdada','aw','Yes','2019-10-04 10:30:00','2019-10-04 10:30:00','adada',8,NULL),(3,'2020-01-28 12:27:51','aw`````','aw\'\'\'\'','Reject','2020-02-14 10:30:00','2020-02-14 09:30:00','aw11```\'\'\'\'',8,'expire'),(4,'2020-01-28 12:29:20','awasd','asdad','No','2020-01-28 10:30:00','2020-01-28 11:30:00','sadad',8,NULL),(5,'2020-01-28 12:48:59','asadd','asdad','No','2020-01-28 10:00:00','2020-01-28 10:00:00','dsdsd',8,NULL),(6,'2020-02-10 08:24:36','ASDASDA````','AWASA````1``````\'\'\'\'\'\'\'','No','2020-02-15 15:30:00','2020-02-15 16:30:00','ASDADAD````',8,NULL);
...
insert  into `csc_members_table`(`cscmemID`,`stprofID`,`positionIDcsc`,`perpost`) values (26,12,2,'Yes'),(27,19,6,'No'),(28,24,9,'No');
...
insert  into `cscreject_announcement_table`(`csc_rejectID`,`stprofID`,`csc_announcementID`,`isApproved`) values (1,12,3,'Reject');
...
insert  into `department_announcement_table`(`DannouncementID`,`dateSubmit`,`toWhom`,`message`,`departmentClubId`,`isApproved`,`timeStart`,`timeEnd`,`subjectann`,`venueID`,`annreason`) values (1,'2020-02-10 09:26:28','asdadadfffdf','asdada',1,'No','2020-02-14 10:30:00','2020-02-14 11:30:00','fdffgfgfdg',8,NULL);
...
insert  into `departmental_officersandmembers_table`(`departmentmemID`,`departmentClubId`,`positionIDdepartmental`,`stprofID`,`perpost`) values (1,1,1,12,'Yes'),(12,2,13,16,'Yes'),(13,2,6,15,'No');
...
insert  into `dsa_announcement_isread_table`(`dsaAnnouncementIsReadID`,`stprofID`,`dsaAnnouncementID`) values (27,12,6),(28,16,6),(29,19,6),(30,18,6),(31,12,7),(32,16,7),(33,17,6),(34,14,6),(35,20,6),(36,20,7),(37,21,6),(38,21,7),(39,22,6),(40,23,6),(41,23,7),(42,25,6),(43,25,7),(44,15,6),(45,15,7),(46,19,7);
...
insert  into `dsa_announcement_table`(`dsaAnnouncementID`,`dateSubmit`,`toWhom`,`message`,`timeStart`,`timeEnd`,`subjectann`,`isApproved`,`venueID`) values (6,'2019-09-08 11:36:27','aw','aw','2019-09-10 09:00:00','2019-09-09 10:00:00','aw','Yes',8),(7,'2019-10-04 03:41:58','to all ngongo','sawasdad','2019-10-04 22:30:00','2019-10-04 23:30:00','test','Yes',8);
...
insert  into `membershiptoggle_table`(`membershipID`,`toggleonoroff`) values (1,'ON');
...
insert  into `social_announcement_isread_table`(`social_announcement_isread_table`,`stprofID`,`social_announcementID`,`socialClubId`,`isApproved`) values (1,12,1,8,'Yes'),(2,19,1,8,'Yes'),(3,12,2,8,'Yes');
...
insert  into `social_announcement_table`(`social_announcementID`,`dateSubmit`,`toWhom`,`message`,`socialClubId`,`isApproved`,`timeStart`,`timeEnd`,`venueID`,`subjectann`,`annreason`) values (1,'2020-01-29 02:12:51','ddd','dsfsfs',8,'Yes','2020-01-30 10:30:00','2020-01-30 12:30:00',9,'dddfd',NULL),(2,'2020-02-10 09:27:04','ad22d','asdad',8,'Yes','2020-02-14 13:30:00','2020-02-14 14:30:00',8,'dfgdfgdfghfxcxv',NULL);
...
insert  into `social_officerandmembers_table`(`socialoffID`,`socialClubId`,`positionIDsocial`,`stprofID`,`perpost`) values (13,5,6,16,'Yes'),(18,10,8,24,'No'),(20,8,1,19,'Yes'),(21,8,4,12,'Yes');
...
insert  into `student_account_table`(`accID`,`StudentID`,`StudentPassword`,`isDeleted`) values (16,1,'1',0),(17,2,'2',0),(18,3,'12',0),(19,12,'1',0),(23,4,'aw',1),(24,7,'7',0),(25,8,'8',0),(26,35181,'aw',0),(27,2323,'aw',1),(28,13,'aw',1),(29,5,'aw',0),(30,10,'12345',0),(31,6,'1',0),(32,80,'123',0),(33,51,'1',0);
...
insert  into `student_portfolio_table`(`stportfolioID`,`stprofID`,`styear`,`sem`,`schoolyr`,`act1`,`rank1`,`act2`,`rank2`,`act3`,`rank3`,`act4`,`rank4`,`comm1`,`comm2`,`comm3`,`comm4`,`seminar1`,`seminar2`,`seminar3`,`seminar4`) values (1,12,'2nd Year','1st Semester','2019-2020','S.o days Mass dance','1st place','dasda','2nd place','','','','','community service','','','','tablet','','new world experience',''),(2,25,'1st Year','1st Semester','2019-2020','Intrams','rank 2','mass dance','2nd runner up','','','','','','','','','ha hatdog','','',''),(3,19,'2nd Year','1st Semester','2019-2020','aw````\'\'\'\'','aw1`','','','','','','','awa','','','','QWAWAW``````\'\'\'\'\'','','','');
...
insert  into `student_social_table`(`stdsocialID`,`stprofID`,`socialClubId`) values (12,12,8),(14,14,8),(15,15,10),(16,16,5),(18,17,8),(19,18,6),(20,19,8),(21,20,13),(22,20,7),(23,21,11),(24,22,8),(25,22,11),(27,23,6),(28,23,8),(29,24,8),(30,24,10),(31,24,6),(32,25,4),(33,26,8),(34,12,4);
...

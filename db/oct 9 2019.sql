...
insert  into `council_officers_table`(`councilID`,`CounID`,`stprofID`,`positionIDcouncil`,`perpost`) values (55,2,18,1,'Yes'),(56,1,12,6,'Yes'),(57,3,14,1,'Yes');
...
insert  into `councilreject_announcement_table`(`council_rejectID`,`stprofID`,`council_announcementID`,`CounID`,`isApproved`) values (12,12,25,1,'Reject'),(13,17,25,1,'Reject');
...
insert  into `course_table`(`CourseID`,`CourseName`,`departmentClubId`,`CounID`,`coursecode`) values (1,'Bachelor of Science in Computer Science',1,1,'BSCS'),(4,'Bachelor of Science  in Nursing',3,3,'BSN'),(6,'Bachelor of Science in Hospitality Management',4,2,'BSHM'),(7,'Bachelor of Science in Computer Engineering',2,1,'BSCPE');
...
insert  into `csc_announcement_isread_table`(`csc_announcementReadID`,`stprofID`,`csc_announcementID`,`isApproved`) values (1,12,1,'Yes'),(2,16,1,'Yes'),(3,12,2,'Yes'),(4,16,2,'Yes'),(5,17,1,'Yes'),(6,14,1,'Yes'),(7,20,1,'Yes'),(8,20,2,'Yes'),(9,21,1,'Yes'),(10,21,2,'Yes'),(11,22,1,'Yes'),(12,23,1,'Yes'),(13,23,2,'Yes');
...
insert  into `csc_members_table`(`cscmemID`,`stprofID`,`positionIDcsc`,`perpost`) values (26,12,4,'Yes'),(27,19,6,'Yes'),(28,17,6,'Yes');
...
insert  into `departmental_officersandmembers_table`(`departmentmemID`,`departmentClubId`,`positionIDdepartmental`,`stprofID`,`perpost`) values (1,1,15,12,'Yes'),(2,2,6,16,'Yes'),(3,2,8,15,'Yes');
...
insert  into `dsa_announcement_isread_table`(`dsaAnnouncementIsReadID`,`stprofID`,`dsaAnnouncementID`) values (27,12,6),(28,16,6),(29,19,6),(30,18,6),(31,12,7),(32,16,7),(33,17,6),(34,14,6),(35,20,6),(36,20,7),(37,21,6),(38,21,7),(39,22,6),(40,23,6),(41,23,7);
...
insert  into `social_officerandmembers_table`(`socialoffID`,`socialClubId`,`positionIDsocial`,`stprofID`,`perpost`) values (11,10,15,16,'Yes'),(12,8,8,12,'Yes'),(13,5,6,16,'Yes');
...
insert  into `student_account_table`(`accID`,`StudentID`,`StudentPassword`,`isDeleted`) values (16,1,'12',0),(17,2,'2',0),(18,3,'12',0),(19,12,'1',0),(23,4,'aw',1),(24,7,'7',0),(25,8,'8',0),(26,35181,'aw',0),(27,2323,'aw',1),(28,13,'aw',1),(29,5,'aw',0);
...
insert  into `student_social_table`(`stdsocialID`,`stprofID`,`socialClubId`) values (12,12,8),(14,14,8),(15,15,10),(16,16,5),(18,17,8),(19,18,6),(20,19,8),(21,20,13),(22,20,7),(23,21,11),(24,22,8),(25,22,11),(26,23,8),(27,23,6);

...
insert  into `department_announcement_isread_table`(`dpannouncementIsReadID`,`stprofID`,`DannouncementID`,`isApproved`,`departmentClubId`) values (1,14,14,'Yes',1),(2,14,15,'Yes',1);
...
insert  into `department_announcement_table`(`DannouncementID`,`dateAnnounced`,`toWhom`,`message`,`departmentClubId`,`isApproved`) values (14,'2019-03-21','Philippine Society of Information Technology Students','testing',1,'Yes'),(15,'2019-03-21','Philippine Society of Information Technology Students','hhhh',1,'Yes'),(16,'2019-03-21','Philippine Nursing Student Association','ghghgh',3,'Yes');
...
insert  into `departmental_officersandmembers_table`(`departmentmemID`,`departmentClubId`,`position`,`stprofID`,`schoolYR`) values (9,1,'Mayor','11',NULL),(10,1,'Vice Mayor','',NULL),(11,1,'Treasurer','',NULL),(12,1,'Secrectary','',NULL),(13,3,'Mayor','15',NULL),(14,3,'Vice Mayor','',NULL),(15,3,'Treasurer','',NULL),(16,3,'Secrectary','',NULL);
...
insert  into `student_account_table`(`accID`,`StudentID`,`StudentPassword`,`isDeleted`) values (7,35181,'7sanjuan',0),(8,48019,'hey',0),(9,47889,'12345',0),(10,47809,'12345',0),(11,524,'hey',0),(12,11,'123',0);
...
insert  into `student_social_table`(`stdsocialID`,`stprofID`,`socialClubId`) values (6,10,5),(7,11,7),(8,12,11),(9,13,4),(10,13,11),(11,14,8),(12,14,10),(13,14,6),(14,15,4);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `departmental_club_announcement_view` AS select `department_announcement_table`.`DannouncementID` AS `DannouncementID`,`department_announcement_table`.`dateAnnounced` AS `dateAnnounced`,`department_announcement_table`.`toWhom` AS `toWhom`,`department_announcement_table`.`message` AS `message`,`department_announcement_table`.`isApproved` AS `isApproved`,`departmental_club_table`.`departmentClubName` AS `departmentClubName` from (`department_announcement_table` join `departmental_club_table` on((`department_announcement_table`.`departmentClubId` = `departmental_club_table`.`departmentClubId`))) */;

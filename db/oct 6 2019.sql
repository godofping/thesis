...
insert  into `admincsc_announcement_isread_table`(`admincsc_announcementID`,`adminID`,`csc_announcementID`) values (1,3,1);
...
insert  into `council_officers_table`(`councilID`,`CounID`,`stprofID`,`positionIDcouncil`,`perpost`) values (46,1,15,3,'No'),(47,1,17,1,'No');
...
insert  into `csc_announcement_isread_table`(`csc_announcementReadID`,`stprofID`,`csc_announcementID`,`isApproved`) values (1,12,1,'Yes'),(2,16,1,'Yes'),(3,12,2,'Yes'),(4,16,2,'Yes');
...
insert  into `csc_announcement_table`(`csc_announcementID`,`dateSubmit`,`toWhom`,`message`,`isApproved`,`timeStart`,`timeEnd`,`subjectann`,`venueID`,`annreason`) values (1,'2019-09-24 03:09:25','adsda','adsad','Yes','2019-09-25 10:00:00','2019-09-25 11:00:00','adada',8,NULL),(2,'2019-10-04 04:10:14','sdada','aw','Yes','2019-10-04 10:30:00','2019-10-04 10:30:00','adada',8,NULL);
...
insert  into `csc_members_table`(`cscmemID`,`stprofID`,`positionIDcsc`,`perpost`) values (18,12,1,'Yes'),(19,15,2,'No'),(20,19,3,'No'),(21,14,6,'Yes'),(22,16,4,'Yes'),(23,17,9,'No');
...
insert  into `dsa_announcement_isread_table`(`dsaAnnouncementIsReadID`,`stprofID`,`dsaAnnouncementID`) values (27,12,6),(28,16,6),(29,19,6),(30,18,6),(31,12,7),(32,16,7);
...
insert  into `dsa_announcement_table`(`dsaAnnouncementID`,`dateSubmit`,`toWhom`,`message`,`timeStart`,`timeEnd`,`subjectann`,`isApproved`,`venueID`) values (6,'2019-09-08 11:36:27','aw','aw','2019-09-10 09:00:00','2019-09-09 10:00:00','aw','Yes',8),(7,'2019-10-04 03:41:58','to all ngongo','awaaa','2019-10-04 22:30:00','2019-10-04 23:30:00','test','Yes',8);
...
insert  into `student_account_table`(`accID`,`StudentID`,`StudentPassword`,`isDeleted`) values (16,1,'12',0),(17,2,'2',0),(18,3,'12',0),(19,12,'1',0),(23,4,'123',0),(24,7,'7',0),(25,8,'8',0),(26,35181,'aw',0),(27,2323,'123',1);

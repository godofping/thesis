...
insert  into `csc_announcement_isread_table`(`csc_announcementReadID`,`stprofID`,`csc_announcementID`,`isApproved`) values (1,12,1,'Yes'),(2,16,1,'Yes'),(3,12,2,'Yes'),(4,16,2,'Yes'),(5,17,1,'Yes'),(6,14,1,'Yes');
...
insert  into `dsa_announcement_isread_table`(`dsaAnnouncementIsReadID`,`stprofID`,`dsaAnnouncementID`) values (27,12,6),(28,16,6),(29,19,6),(30,18,6),(31,12,7),(32,16,7),(33,17,6),(34,14,6);
...
insert  into `social_club_table`(`socialClubId`,`socialClubName`,`socialClubcode`) values (4,'Youth Servant Leaders Clubs','YSLC'),(5,'Kristiyanong Kabataan para sa Bayan','KKB'),(6,'Catechetical Guild','CB'),(7,'Muslim Students Organization','MSO'),(8,'Association of Student Personnel Assistants','ASPA'),(9,'Peer Counselors Club','PCC'),(10,'Cantores et Sesyonistas','CES'),(11,'Junior Ecologist Movement','JEM'),(12,'Sports Club','SP'),(13,'Karate-do Club','KDC');

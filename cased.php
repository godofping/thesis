  ...
  <div class="row">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <button class="btn btn-success" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus"></i> ADD CAS-ED officer</button>
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  <div class="col-12">
                      ...
                      <select class="form-control" name="casedposition" required="">

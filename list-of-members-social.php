  ...
  <div class="row">
      <div class="col-md-12">
        ...
        <?php 
          ...
          if (isset($_GET['from']) and $_GET['from'] == 'checkIDforsocialmember') {
      ...
      <div class="col-md-12 z-depth-2">
        ...
        <table class="table" id="dtBasicExample">
          ...
          <tbody>
                ...
                <?php 
            $qry = mysqli_query($connection, "select * from list_social_club_view where socialClubId = '".$resid['socialClubId']."' ");

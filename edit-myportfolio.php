...
<main class=" py-5 mt-5">
  ...
  <div class="row">
    ...
    <?php 
                ...
                $stportfolioID = $result['stportfolioID'];
             ?>
    ...
    <div class="row">
      ...
      <form class=" border border-light p-3"  method="POST" action="controller.php" autocomplete="false" enctype="multipart/form-data">
           ...
           <p class="h4 mb-4 text-center">Edit your Information</p>
            ...
            <div class="col">
              <div class="row">
                    ...
                    <div class="row">                  
                      ...
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="schoolyr" id="form5" class="form-control" placeholder="ex. 2019-2020" required="" value="<?php echo $result['schoolyr']; ?>">
        ...
        <p class="h5 mb-4 mt-4 text-left">A.] Activities joined/participated</p>
         ...
         <div class="row ">                  
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="act1" class="form-control" placeholder="ex. Intrams, Mass dance" required="" value="<?php echo $result['act1'] ?>">
                      ...
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="rank1" class="form-control" placeholder="ex. 1st place, Rank 1" required="" value="<?php echo $result['rank1']?>">
        ...
        <div class="row">                  
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="act2" class="form-control" value="<?php echo $result['act2'] ?>">
                        </div>
                      </div>
                    
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="rank2" class="form-control" value="<?php echo $result['rank2']?>">
                        </div>
                      </div>
        ...
        <div class="row">                  
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="act3" class="form-control" value="<?php echo $result['act3'] ?>">
                        </div>
                      </div>
                    
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="rank3" class="form-control" value="<?php echo $result['rank3']?>">
                        </div>
                      </div>
        ...
        <div class="row">                  
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="act4" class="form-control" value="<?php echo $result['act4'] ?>">
                        </div>
                      </div>
                    
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="rank4" class="form-control" value="<?php echo $result['rank4']?>">
                        </div>
                      </div>
        ...
        <div class="row">                  
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="comm1" class="form-control" value="<?php echo $result['comm1'] ?>">
                        </div>
                      </div>
                    
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="comm2" class="form-control" value="<?php echo $result['comm2'] ?>">
                        </div>
                      </div>
        ...
        <div class="row">                  
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="comm3" class="form-control" value="<?php echo $result['comm3'] ?>">
                        </div>
                      </div>
                    
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="comm4" class="form-control" value="<?php echo $result['comm4'] ?>">
                        </div>
                      </div>
    ...
    while ($ressocialclub = mysqli_fetch_assoc($qrysocialclub)) {?>
        ...
        <div class="row">                  
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="seminar1" class="form-control" value="<?php echo $result['seminar1'] ?>">
                        </div>
                      </div>
                    
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="seminar2" class="form-control" value="<?php echo $result['seminar2'] ?>">
                        </div>
                      </div>
        ...
        <div class="row">                  
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="seminar3" class="form-control" value="<?php echo $result['seminar3'] ?>">
                        </div>
                      </div>
                    
                      <div class="col">      
                        <div class="md-form">
                          <input type="text" name="seminar4" class="form-control" value="<?php echo $result['seminar4'] ?>">
                        </div>
                      </div>
                      
                    </div> 

          <input type="text" name="stportfolioID" value="<?php echo $stportfolioID ?>" hidden>  
          <input type="text" name="stprofID" value="<?php echo $profID ?>" hidden>  
          <input type="text" name="from" value="edit_student_portfolio" hidden>

          <button class="btn blue-gradient btn-block my-4" type="submit">Save Changes</button>

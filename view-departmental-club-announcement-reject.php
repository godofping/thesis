    ...
    <div class="row mt-5">
      <div class="col-md-12">
        ...
        <table class="table" id="dtBasicExample">
          ...
          <tbody>
            <?php 
            $qrycscann = mysqli_query($connection, "select * from departmental_club_announcement_view where isApproved = 'Reject' ");
            while ($rescscann = mysqli_fetch_assoc($qrycscann)) { ?>
              ...
              <td><a href="" class="btn btn-default blue-gradient mb-4 itogglebutton" data-toggle="modal" data-target="#modalContactForm<?php echo $rescscann['DannouncementID']; ?>">View</a></td>
